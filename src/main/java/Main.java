...
public class Main {
	public static void main(String[] args) throws IOException {
		...
		System.out.println("**********************");
		System.out.println("Cross Validation Accuracy before java.Pruning: " + r / 10);
		System.out.println("Cross Validation Accuracy after java.Pruning: " + rP / 10);
		System.out.println("**********************");
		...
		if (printTreeBefore.equals("y")) {
			System.out.println("Tree before java.Pruning: \n" + print.printDFS(cv.getRoot()));
		}
		System.out.println("**********************");
		...
		if (printTreeAfter.equals("y")) {
			System.out.println("Tree after java.Pruning: \n" + print.printDFS(cvP.getRoot()));
		}
		System.out.println("**********************");
